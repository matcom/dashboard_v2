...
public class PNAPSheet : ProyectosSheetBase
{
    public PNAPSheet() : base(
        name: "PNAP",
        title: "Proyectos PNAP",
        headers: new[] 
        {
            "Código del proyecto",
            "Título del proyecto",
    ...
    public override IEnumerable<(int Col, string Expression)> TemplateCells => new[]
    {
        ...
        (11,  "{{item.TributaDesarrolloLocal}}"),
        (12,  "{{item.FinanciamientoUH}}"),
