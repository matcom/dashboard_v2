...
/// Si el usuario no tiene perfil de autor, construye el nombre completo desde
/// <c>UserName</c>, <c>UserLastName1</c> y <c>UserLastName2</c> y persiste el nuevo <see cref="Author"/>.
/// </summary>
public class AuthorResolutionService : IAuthorResolutionService
{
    ...
    public async Task<Author?> GetOrCreateForUserAsync(
        string userId,
