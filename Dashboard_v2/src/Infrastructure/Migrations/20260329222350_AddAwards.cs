    ...
    public partial class AddAwards : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAwardeds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAwardeds_Awards_AwardId",
                        column: x => x.AwardId,
                        principalTable: "Awards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAwardeds_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAwardeds_AwardId",
                table: "UserAwardeds",
                column: "AwardId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAwardeds_UserId",
                table: "UserAwardeds",
                column: "UserId");
        }
